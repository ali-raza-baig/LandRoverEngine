...
const VehicleCard = ({ img, IconBadge, badgeText, name, gen, alt }: IProps) => {
    return (
        <div className='relative w-38 h-35 lg:w-70 lg:h-60 2xl:w-120 2xl:h-120 rounded-md border border-golden p-1 '>
            ...
            <img src={img} className='rounded-md w-38 h-32 lg:w-70 lg:h-57 2xl:w-120 2xl:h-118' alt={alt} />
