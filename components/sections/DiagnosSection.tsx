...
const DiagnosSection = () => {
    ...
    return (
        <section className='pt-10 pb-10 bg-[#070E17]'>
            <div className='w-full max-w-3xl mx-auto text-center'>
                ...
                <p className='text-base lg:text-lg 2xl:text-xl p-2'>Answer a few questions about your symptoms — we'll match you against 15+ known JLR failure patterns, show you the likely diagnosis, OEM part references, and an honest repair vs. replace cost estimate.
                </p>
            </div>
            ...
            <div className='rounded-md border border-golden p-4 max-w-5xl mx-auto'>
