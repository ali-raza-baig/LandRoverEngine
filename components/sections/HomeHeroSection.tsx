    ...
    return (
        <>
            <section className="relative min-h-screen overflow-hidden border-b border-golden">
                ...
                {/* Content */}
                <div className="container-1 relative z-10 flex flex-col h-full justify-center">
                    <div className="w-full lg:max-w-2xl  mt-20 xl:mt-22 px-2  md:px-8 lg:px-10 text-white">
                        <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-tight">
                            The UK's Most Trusted Land Rover & Range Rover Ownership Guide
                        </h1>

                        <p className="mt-6 max-w-xl text-sm md:text-base leading-relaxed text-gray-200">
                    ...
                    <div className='px-2 lg:px-10 mt-10  flex flex-wrap gap-4 pb-2'>
                        {trustStrip.map((t, i) => (
                            <div className={` flex flex-col lg:flex-row gap-2 w-[41%] lg:w-40 ${i === trustStrip.length - 1 ? 'border-r border-golden lg:border-0' : 'border-r border-golden'}`}>
                                <t.icon className='text-golden text-sm md:text-base ' size={35} />
            ...
            <div className='container-1  flex items-center justify-center flex-wrap gap-2'>
                {trustBadges.map((t) => (
                    <div className='flex flex-col lg:flex-row gap-3 rounded-md border border-golden w-[47%] lg:w-[23%] p-4'>
