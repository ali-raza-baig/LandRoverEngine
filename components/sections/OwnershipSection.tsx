    ...
    return (
        <section className=' py-10 bg-[#070E17]'>
            <div className='w-full max-w-3xl mx-auto text-center'>
                ...
                <p className='text-base lg:text-lg 2xl:text-xl'>The verdicts people actually want before they read a single spec sheet — the calls we'd make for a friend, backed by real UK enquiry and failure data.
                </p>
            </div>
