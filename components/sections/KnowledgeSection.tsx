    ...
    return (
        <section className=' py-10 bg-[#070E17]'>
            <div className='w-full max-w-3xl mx-auto text-center'>
                ...
                <p className='text-base lg:text-lg 2xl:text-xl'>Deep, permanent reference hubs for the engines and systems Land Rover owners research most — not blog posts, not one-off articles. Every guide is built on real UK enquiry data and JLR-specific expertise.
                </p>
            </div>
